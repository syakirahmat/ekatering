...
$query_Recordset1 = "SELECT tbladmin.email, tbladmin.password FROM tbladmin";
...
if (isset($_POST['email'])) {
  ...
  $MM_redirectLoginSuccess = "../kaijuthemes/tectonic.kaijuthemes.com/index.html";
  $MM_redirectLoginFailed = "loginadmin.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_katering, $katering);
  
  $LoginRS__query=sprintf("SELECT email, password FROM tbladmin WHERE email=%s AND password=%s",
...
<form ACTION="<?php echo $loginFormAction; ?>" METHOD="POST" class="">
                                  ...
                                  <label><b><center> Username</center></b></label>
