            ...
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <h2 class="intro-text text-center">
                        <strong>Menu Makanan Pakej</strong>
                    </h2>
                    <hr>
                </div>
    
                <div class="col-md-4">
                    <img class="img-responsive img-border-left" src="img/nasiayampenyet.jpg" alt="">
                </div>
                <div class="col-md-4">
                      <div class="row">
                    <div class="col-md-12 centered">
                        <div class="row">
                            <!-- form start -->
                            <h4>Details</h4><br>
                           <p><h8>Menu: Nasi Ayam Penyet<br>
                                  Price: RM5.00<br></p>
                   </div><br>
                        <div class="button">
                        <input type="submit" class="otw-submit" value="Tempah">
                        </div>
                    </div><!-- .col-md-12 end -->
                </div><!-- .row end -->
            </div><!-- .container end -->
