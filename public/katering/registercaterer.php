            ...
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <h2 class="intro-text text-center">
                        <strong>Daftar Katerer Baru</strong>
                    </h2>
                         ...
                         <table style="width:100%">
                          ...
                          <tr>
                            <td><p><input type="text" class="form-control"></p></td>
                            <td><p><input type="psw" class="form-control"></p></td> 
                            <td><p><input type="email" class="form-control"></p></td> 
                            <td><p><input type="text" class="form-control"></p></td> 
                            <td><p><input type="text" class="form-control"></p></td> 
                            </table></form/>
                            <div><center>
                        <input type="submit" class="otw-submit" value="Daftar"></center>
                          </div>
