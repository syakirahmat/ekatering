...
if ($wapakpak > 0) {
	...
	<a href="javascript:Clickheretoprint()" style="font-size:20px" ;>Print</a>|<a href="index.php"
	                                                                              style="font-size:20px" ;>Back</a>
	<div class="content" id="content"
	     style="width: 700px; font-size:13px; font-family:arial; font-weight:normal; margin:0 auto;">
