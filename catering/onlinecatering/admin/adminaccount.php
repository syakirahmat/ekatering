...
<div class="container  clearfix">
	<div class="one-third1 column">
		<ul>
			...
			if ($jhjh == 1) {
				?>
				<li class="active"><a href="adminaccount.php"><img alt="" src="img/userpic.png"><span>Maintenance</span></a>
				</li>
				<?php
			}
			?>
	...
	<div class="two-thirds1 column">
		<div class="thewraper">
			...
			<a rel="facebox" href="addadmin.php"> Add Admin </a> &nbsp;&nbsp; <a href="backup/export.php"> Backup </a>
			&nbsp;&nbsp; <a href="backup/import.php"> Restore Backup </a><br><br>
			<table id="resultTable" data-responsive="table">
				...
				for ($i = 0; $row = $result->fetch(); $i++) {
					...
					<tr class="record">
						...
						<td><a rel="facebox" href="editteaccount.php?id=<?php echo $row['id']; ?>"> Edit </a> | <a
