	...
	if ($ewewe >= 7) {
		...
		if ($wapak == 'catering') {
			...
			<form action="catering.php" method="post" name="catering" onsubmit="return validateFormas()">
				...
				Masa: <br/><input type="text" name="time" required="required" maxlength="5"/> <select name="dws">
					<option>AM</option>
					<option>PM</option>
				</select>
				Lokasi: <br>
				...
				<br>
				Tempat: <br><input type="text" name="vn" style="margin-bottom: 13px; width: 298px;" required="required"
				                   maxlength="100"/><br>
				Bil. Pax: <br><input type="text" name="nopax" style="margin-bottom: 13px; width: 298px;"
			...
			<br>
			Tempat: <br><input type="text" name="vn" value="Function Hall" style="margin-bottom: 13px; width: 298px;"
			                   required="required"/><br>
			Bil. Pax: <br><input type="text" name="nopax" value="80" style="margin-bottom: 13px; width: 298px;"
			                     onKeyPress="return isNumberKey(event)" maxlength="5" required="required"/><br>
			Pilih Katerer: <br>
			<select name="cat" style="margin-bottom: 13px; width: 298px;">
				<option>&nbsp;</option>
				<?php
