...
<div class="container  clearfix">
	<div class="one-third1 column">
		<ul>
			...
			<li><a href="menuorders.php"><img alt="" src="img/menuorder.png"><span>Tempahan Menu</span></a></li>
			<li><a href="suggestions.php"><img alt="" src="img/mesage.png"><span>Laporan</span></a></li>
			...
			<table id="resultTable" data-responsive="table">
				...
				for ($i = 0; $row = $result->fetch(); $i++) {
					...
					<tr class="record">
						...
						<td><a rel="facebox" href="editteammember.php?id=<?php echo $row['ctm_id']; ?>"> Edit </a> | <a
								href="#" id="<?php echo $row['ctm_id']; ?>" class="delbutton" title="Click To Delete">Delete</a>
						</td>
					</tr>
					<?php
				}
