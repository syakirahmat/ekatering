...
<div class="container  clearfix">
	...
	<div class="two-thirds1 column">
		<div class="thewraper">
			<div id="formdesign"><input type="text" name="filter" value="" id="filter" placeholder="cari..."
			...
			<table id="resultTable" data-responsive="table">
				...
				for ($i = 0; $row = $result->fetch(); $i++) {
					...
					<tr class="record">
						...
						<td><a rel="facebox" href="editteam.php?id=<?php echo $row['ct_id']; ?>"> Ubah </a> | <a
								href="#" id="<?php echo $row['ct_id']; ?>" class="delbutton" title="Click To Delete">Hapus</a>
						</td>
					</tr>
					<?php
				}
