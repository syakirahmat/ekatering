...
<div style='margin-top:75px; position:absolute;'>
	<ul style='overflow:hidden; background-color:#333; width:1325px; list-style-type:none;'>
		<li style='float:left;'>
			<a style='padding:14px 16px; display:block; color:white; text-align:center; text-decoration:none;'
			   href='userHome.php'>
				Home
			</a>
		</li>
		<li style='float:left;'>
			<a style='padding:14px 16px; display:block; color:white; text-align:center; text-decoration:none;'
			   href='userTypeOfRoom.php'>
				Types Of Room
			</a>
		</li>
		<li style='float:left;'>
			<a style='padding:14px 16px; display:block; color:white; text-align:center; text-decoration:none;'
			   href='userSpecialService.php'>
				Special Services
			</a>
		</li>
		<li style='float:left;'>
			<a style='padding:14px 16px; display:block; color:white; text-align:center; text-decoration:none;'
			   href='userBookNow.php'>
				Book Now
			</a>
		</li>
		<li style='float:left;'>
			<a style='padding:14px 16px; display:block; color:white; text-align:center; text-decoration:none;'
			   href='userReviewReservation.php'>
				Review Reservation
			</a>
		</li>
		<li style='float:right;'>
			<a style='padding-top:14px; padding-right:48px; display:block; color:white; text-align:center; text-decoration:none;'
			   href='userContactUs.php'>
				Contact Us
			</a>
		</li>
		<li style='float:right;'>
...
<div
	style='margin-top:150px; margin-left:150px; position:absolute; background-color:pink; width:1075px; min-height:475px;'>
