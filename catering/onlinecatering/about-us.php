					...
					<div class="slider">
						<div id="slidercon">
							...
							<div id="about" style="height: 165px; width: 279px;">
								<!--Edit Here-->
								Sistem ini dibangunkan untuk memudahkan pengguna, katerer dan juga pentadbir iaitu Pejabat Bendahari UTHM untuk membuat pengurusan tempahan makanan di dalam UTHM. Katerer-katerer yang terlibat merupakan katerer yang berdaftar di bawah Pejabat Bnedahari UTHM.
							</div>
							<div id="title">
								<b>Misi</b>
							</div>
							<div id="about" style="height:67px; width: 279px;">
								<!--Edit Here-->
								Untuk menyediakan perkhidmatan terbaik di dalam UTHM.
							</div>
							<div id="title">
								<b>Visi</b>
							</div>
							<div id="about" style="height:100px; width: 279px;">
								<!--Edit Here-->
							   Meluaskan lagi skop jika sistem boleh digunapakai dengan baik.
							</div>
							</div>
						</div>
					</div>
